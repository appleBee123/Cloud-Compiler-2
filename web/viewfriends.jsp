  ...
  <link href="css/bootstrap.css" rel="stylesheet" type="text/css"/>
        ...
        <script>
            function unfriendlogic(fid)
            {
                ...
                var url = "./unfriendresponse?fid="+fid;
             ...
             <div style="border: 10px dotted black; margin: 40px">
                 <div class="row">
                     ...
                     <div class="offset-md-3 col-md-2">
                         <input type="button" value="Unfriend" class="btn btn-warning" style="margin-top: 35px; font-weight: bold" onclick="unfriendlogic(<%= fid %>)" />
                     </div>
                 </div>
             </div>
             <%
