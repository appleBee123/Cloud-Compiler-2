...
public class cpp_compile_code_step_2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
           ...
           ProcessBuilder pb = new ProcessBuilder("cmd","/c","g++ " + filename + ".cpp -o " + filename);
           Map<String,String> environment = pb.environment();
           environment.clear();
           environment.put("Path",path.cpp);
           ...
           {
               is = p.getErrorStream();
               File f1 = new File(absolutepath + "\\" + filename + ".cpp");
               if(f1.exists())
               {
                   f1.delete();
               }
